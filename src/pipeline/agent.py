...
def run_pipeline() -> PipelineResult:
    ...
    decision_trace: dict[str, Any] = {
        ...
        "selected_effective_score": round(float(selection_result.effective_auc), 6),
        ...
        "selection_fast_mode_row_limit": int(DEFAULT_CONFIG.selection_fast_mode_row_limit),
        ...
        "llm_min_seconds_remaining": int(DEFAULT_CONFIG.llm_min_seconds_remaining),
        "llm_large_dataset_row_limit": int(DEFAULT_CONFIG.llm_large_dataset_row_limit),
